...
// import { Mail, Shield, Edit, Save, X, Calendar, Eye, EyeOff, User, MapPin, Phone, Sparkles } from "lucide-react"
...
//         <Sidebar />
//         <div className="flex-1 md:ml-64 flex items-center justify-center">
//           <p className="text-slate-600 text-lg">Aucune donnée de profil trouvée</p>
//         </div>
//       </div>
//     )
//   }
...
//     <div className="flex min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100">
//       {/* <Sidebar /> */}
//       <div className="flex-1 border  p-4 md:p-8">
...
//                         />
//                       ) : (
//                         <p className="text-slate-900 font-medium bg-slate-50 p-3 rounded-xl">{profileData.firstName}</p>
//                       )}
//                     </div>
//                     <div>
...
//                         />
//                       ) : (
//                         <p className="text-slate-900 font-medium bg-slate-50 p-3 rounded-xl">{profileData.lastName}</p>
//                       )}
//                     </div>
//                     <div>
...
//                         />
//                       ) : (
//                         <p className="text-slate-900 font-medium bg-slate-50 p-3 rounded-xl">{profileData.email}</p>
//                       )}
//                     </div>
//                     <div>
...
//                         />
//                       ) : (
//                         <p className="text-slate-900 font-medium bg-slate-50 p-3 rounded-xl">{profileData.phone}</p>
//                       )}
//                     </div>
//                   </div>
//                   <div className="space-y-6">
...
//                         />
//                       ) : (
//                         <p className="text-slate-900 font-medium bg-slate-50 p-3 rounded-xl">{profileData.city}</p>
//                       )}
//                     </div>
//                     <div>
...
//                       </div>
//                       <div>
//                         <p className="font-semibold text-slate-900">Notifications par email</p>
...
//                       <p>
//                         <span className="font-medium">Rôle:</span> {profileData.role}
//                       </p>
//                       <p>
...
//             <Card className="bg-white/80 backdrop-blur-sm  border rounded-2xl overflow-hidden border-red-200">
...
//                   <Button
//                     variant="outline"
//                     className="w-full border-red-300 text-red-600 hover:bg-red-50 bg-white/80 backdrop-blur-sm rounded-xl"
