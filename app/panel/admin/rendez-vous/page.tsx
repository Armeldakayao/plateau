        ...
        <div className="overflow-x-auto">
          <table className="w-full">
            <thead className="bg-gray-50 border-b border-gray-200">
              <tr>
                <th className="text-left py-4 px-4 md:px-6 font-semibold text-gray-700 text-sm">Date & Heure</th>
                <th className="text-left py-4 px-4 md:px-6 font-semibold text-gray-700 text-sm">Service demandé</th>
                <th className="text-left py-4 px-4 md:px-6 font-semibold text-gray-700 text-sm">Nom du Citoyen</th>
                <th className="text-left py-4 px-4 md:px-6 font-semibold text-gray-700 text-sm">Contact</th>
                ...
                <tr key={rdv.id} className="border-b border-gray-100 hover:bg-gray-50 transition-colors">
                  ...
                  <td className="py-4 px-4 md:px-6">
                    <div className="flex items-center gap-2">
                      <Link href={`/admin/rendez-vous/${rdv.id}`}>
