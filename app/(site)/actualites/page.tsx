...
import { getFeaturedNews, newsData } from "@/lib/news-data"
// import { newsData, getFeaturedNews } from "@/lib/news-data"
  ...
  const filteredArticles = useMemo(() => {
    ...
    if (selectedCategory !== "all") {
      const categoryMap: { [key: string]: string } = {
        official: "Communiqué officiel",
        citizen: "Vie citoyenne",
        "public-works": "Travaux publics",
        events: "Événementiel",
        environment: "Environnement",
        associations: "Vie associative",
        democracy: "Démocratie participative",
        commerce: "Commerce local",
        equipment: "Équipements publics",
      }
            ...
            <motion.div variants={itemVariants}>
              <Select value={selectedCategory} onValueChange={setSelectedCategory}>
                ...
                <SelectContent className="bg-white text-gray-800">
                  ...
                  <SelectItem value="associations">Vie associative</SelectItem>
                  <SelectItem value="democracy">Démocratie participative</SelectItem>
                  <SelectItem value="commerce">Commerce local</SelectItem>
                  <SelectItem value="equipment">Équipements publics</SelectItem>
                </SelectContent>
              </Select>
            </motion.div>
            <motion.div variants={itemVariants}>
          ...
          <section className="mb-16">
            ...
            >
              <Card className="border-none shadow-none mx-auto rounded-lg overflow-hidden hover:shadow-lg transition-shadow">
                <Image
                  src={featuredNews.imageSrc || "/placeholder.svg"}
